...
> daraus überprüfbare Regeln – von Hand, bevor daraus Code wird. Editor,
> Browser und KI bleiben zu.

**Dauer:** 35' inklusive Besprechung · **Methode:** Think-Pair-Share mit
Fehlerdiagnose · **Sozialform:** Einzelarbeit → Partnerarbeit → Plenum
...
In der Theorie haben die Studierenden die sieben Formen kennengelernt: filtern,
...
Wer direkt mit `transform.php` anfängt, hält Transformieren für Aufräumen. Es
ist aber eine Kette von Entscheidungen, und jede davon folgt aus der Datenfrage.

## Material

- [`arbeitsblatt.html`](arbeitsblatt.html) pro Person, A4 quer (im Browser
  öffnen, `Cmd+P`, Hintergrundgrafiken an);
- Stift, kein Laptop, keine KI;
- Whiteboard;
- [`loesung.html`](loesung.html) erst zur Besprechung – Seite 1 zeigen, Seite 2
  als Handout nach der Diskussion.
