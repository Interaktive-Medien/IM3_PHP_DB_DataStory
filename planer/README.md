...
1. `config.php` in diesem Ordner anlegen, nach dem Muster von
   [`config.template.php`](../config.template.php), und zusätzlich
   `$planerPasswort` für den Bearbeiten-Modus setzen.
